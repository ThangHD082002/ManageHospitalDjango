...
from doctor.models import User,  Account
from doctor.serializers import UserSerializer1, FullnameSerializer, AddressSerializer, AccountSerializer, SpecialtySerializer, IdentifySerializer
