...
def send_reset_password_email(request):
    ...
    message = f'Please click the link below to reset your password:\n\n{request.build_absolute_uri(reverse("forgot_password:reset_password"))}?uidb64={urlsafe_base64_encode(force_bytes(user.account.pk))}&token={token}'
    # message = "ban can reset mk"
    send_mail(subject, message, 'thanghd2708@gmail.com', [email])
