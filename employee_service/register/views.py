...
from employee.models import User,  Account
from employee.serializers import UserSerializer1, FullnameSerializer, AddressSerializer, AccountSerializer, SpecialtySerializer, IdentifySerializer
